...
const PortfolioSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: 'enterprise',
      image: AdaaPhoto,
      description: 'Integrated system for patient records, scheduling, and billing for healthcare providers.',
    ...
    },
    {
      ...
      category: 'mobile',
      image: 'https://is1-ssl.mzstatic.com/image/thumb/Purple211/v4/70/65/7f/70657fa4-b039-bac6-e822-7deaa741e870/AppIcon-0-0-1x_U007emarketing-0-8-0-85-220.png/230x0w.webp',
    ...
    },
    {
      ...
      category: 'enterprise',
      image: AnmatPhoto,
      description: 'Property listing, management, and analytics platform for real estate agencies.',
    ...
    },
    {
      ...
      category: 'enterprise',
      image: MMSPhoto,
      description: 'Comprehensive inventory tracking and management solution for manufacturing businesses.',
    ...
    <section id="portfolio" className="portfolio-section">
      <div className="container">
       ...
       <motion.div 
        ...
        >
          <a href="#contact" className="btn primary">Start Your Project Today</a>
        </motion.div>
      </div>
    </section>
  );
